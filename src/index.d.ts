...
export interface ITipProvider {
	...
	pulseStyle?: ViewStyle
	/**
	 * If true, when you try and click off the tip while in a tour it will just go to the next step
	 */
	tourDismissable?: boolean
	/**
	 * Set this as the background of the tip
	 */
